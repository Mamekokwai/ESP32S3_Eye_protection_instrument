...
///////for WOLCD  WA54TE057I-20Z////////////
   //  {cmd, (uint8_t[]){ data }, data_size, delay_ms}
    ...
    {0xBB, (uint8_t[]){0x1B,0x5B,0xD4,0x23,0x3E,0xF3}, 6, 0},
    ...
    {0xCA, (uint8_t[]){0x08,0x1F,0x1E,0x17,0x18}, 5, 0},
    {0xCB, (uint8_t[]){0x03,0x01,0x07,0x05,0x0B}, 5, 0},
    {0xCC, (uint8_t[]){0x09,0x1F,0x1E,0x17,0x18}, 5, 0},
    {0xCD, (uint8_t[]){0x21,0x23,0x29,0x2B,0x25}, 5, 0},
    {0xCE, (uint8_t[]){0x27,0x3E,0x3F,0x37,0x38}, 5, 0},
    {0xCF, (uint8_t[]){0x20,0x22,0x28,0x2A,0x24}, 5, 0},
    {0xD0, (uint8_t[]){0x26,0x3E,0x3F,0x37,0x38}, 5, 0},
    ...
    {0xD4, (uint8_t[]){0x67,0x00,0x00,0x02,0x02,0x01}, 6, 0},
